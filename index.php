...
/**
 *
 * Content: Template par défaut du thème
 * Si aucun template n'est trouvé pour une page, ce template sera choisie
 */
...
?>
    ...
    <div class="main-content">
                ...
                <div class="rev_slider_wrapper">
                    <div class="rev_slider" data-version="5.0">
                        <ul>
                            ...
                            <!-- SLIDE 1 -->
                            <li data-index="rs-1" data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="http://placehold.it/1920x1280" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Web Show" data-description="">
                                <!-- MAIN IMAGE -->
                                ...
                                <div class="tp-caption tp-resizeme"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-circled btn-theme-colored" href="#">Become a member</a>
                                </div>
                            </li>
                            ...
                            <li data-index="rs-2" data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="http://placehold.it/1920x1280" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Web Show" data-description="">
                                ...
                                <div class="tp-caption tp-resizeme text-uppercase font-raleway text-center text-white"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 5; white-space: nowrap; font-weight:600;">We Always Look After
                                </div>
                                ...
                                <div class="tp-caption tp-resizeme text-uppercase font-raleway text-center text-white bg-dark-transparent pl-10 pr-10"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 5; white-space: nowrap; font-weight:700;">Your Health
                                </div>
                            ...
                            <li data-index="rs-3" data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="http://placehold.it/1920x1280" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Web Show" data-description="">
                                ...
                                <div class="tp-caption tp-resizeme"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a class="btn btn-colored btn-flat btn-theme-colored" href="#">Become a member</a>
                                </div>
                            </li>
            ...
            <div class="container pb-0">
                ...
                <div class="col-md-5">
                    <div class="meet-doctors">
                        <h6 class="text-uppercase letter-space-5 mt-0 mt-sm-20">Welcome to HealthZone</h6>
                        ...
                        <div class="training-classes-carousel" data-dots="true">
                            <div class="item">
                                <div class="class-item box-hover-effect effect1 mb-md-30 bg-lighter">
                                    ...
                                    <div class="content text-left p-25 pt-0 flip">
                                        <h4 class="line-bottom">Areas of practice</h4>
                                        <p>Ipsum dolor sit amet, consectetur adipisicing elit. Quaerat voluptas tempore doloribus exercitationem, quasi deserunt itaque temporibus in esse, quibusdam minima ex non, nam tenetur. Tempore earum possimus quasi! Aliquam!</p>
                            ...
                            <div class="item">
                                <div class="class-item box-hover-effect effect1 mb-md-30 bg-lighter">
                                    <div class="thumb mb-20"> <img alt="featured project" src="http://placehold.it/328x283" class="img-responsive img-fullwidth"> </div>
                                    <div class="content text-left p-25 pt-0 flip">
                                        <h4 class="line-bottom">Classification systems</h4>
                                        <p>Ipsum dolor sit amet, consectetur adipisicing elit. Quaerat voluptas tempore doloribus exercitationem, quasi deserunt itaque temporibus in esse, quibusdam minima ex non, nam tenetur. Tempore earum possimus quasi! Aliquam!</p>
                                        <a href="#" class="btn-read-more btn-sm">Read More</a>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="class-item box-hover-effect effect1 mb-md-30 bg-lighter">
                                    <div class="thumb mb-20"> <img alt="featured project" src="http://placehold.it/328x283" class="img-responsive img-fullwidth"> </div>
                                    <div class="content text-left p-25 pt-0 flip">
                                        <h4 class="line-bottom">Education and licensure</h4>
                                        <p>Ipsum dolor sit amet, consectetur adipisicing elit. Quaerat voluptas tempore doloribus exercitationem, quasi deserunt itaque temporibus in esse, quibusdam minima ex non, nam tenetur. Tempore earum possimus quasi! Aliquam!</p>
                                        <a href="#" class="btn-read-more btn-sm">Read More</a>
                                    </div>
                                </div>
        ...
        <!-- divider:  -->
        <section class="divider parallax layer-overlay overlay-dark"  data-parallax-ratio="0.7" data-bg-img="http://placehold.it/1920x1280">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="call-to-action pt-10 pb-40 mb-20 ">
                                ...
                                <a class="btn btn-default mr-10" href="#">Join Now</a>
                                <a class="btn btn-theme-colored" href="#">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4 hvr-float-shadow mb-sm-30">
                            <div class="pricing-table style1 bg-white-light border-2px border-theme-colored text-center">
                                <div class="pt-40 pb-60">
                                    <h3 class="package-type mt-40">Blood Test</h3>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 hvr-float-shadow mb-sm-30">
                            <div class="pricing-table style1 bg-white-light border-2px border-theme-colored text-center">
                                <div class="pt-40 pb-60">
                                    <h3 class="package-type mt-40">Medical Checkup</h3>
                                    <p>Hurry to grap your offer now</p>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 hvr-float-shadow mb-sm-30">
                            <div class="pricing-table style1 bg-white-light border-2px border-theme-colored text-center">
                                <div class="pt-40 pb-60">
                                    <h3 class="package-type mt-40">Personal Care</h3>
                                    <p>Hurry to grap your offer now</p>
        ...
        <section class="divider parallax layer-overlay overlay-black" data-bg-img="http://placehold.it/1920x1280">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="testimonial-carousel fullwidth">
                            <div class="item text-center">
                                <div class="thumb"><img src="http://placehold.it/90x90" alt="" width="90" class="img-circle"></div>
                                <div class="content">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum feugiat turpis nec leo pellentesque tincidunt. Aliquam erat volutpat. Integer non porta lorem.</p>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="row multi-row-clearfix">
                                <div class="products-carousel products" data-dots="true" data-nav="true">
                                    <div class="item">
                                        <div class="product">
                                            ...
                                            <div class="product-details text-center">
                                                <a href="#"><h5 class="product-title">Product Title Here</h5></a>
                                                ...
                                                <div class="btn-add-to-cart-wrapper no-bg">
                                                    <a class="btn btn-default btn-sm btn-add-to-cart" href="#">Add To Cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row equal-height-inner clearfix">
                                <div class="col-sm-12 col-md-5 pr-0 pr-sm-15 sm-height-auto">
                                    <div class="entry-header md-height-auto">
                                        <div class="post-thumb thumb"> <img class="img-responsive md-height img-fullwidth" alt="" src="http://placehold.it/370x350"> </div>
                                                ...
                                                <div class="display-table-cell">
                                                    <ul class="font-12">
                                                        <li><a href="#" class="text-white"><i class="fa fa-thumbs-o-up"></i> <br>
                                                                30 Likes</a></li>
                                                        <li class="mt-20 mt-md-10"><a href="#" class="text-white"><i class="fa fa-comments-o"></i> <br>
                                                                72 Comments</a></li>
                                                        <li class="mt-20 mt-md-10"><a href="#" class="text-white"><i class="fa fa-share-square-o"></i> <br>
                                                                Share</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="display-table-cell">
                                                    <ul class="font-12">
                                                        ...
                                                        <li class="mt-20 mt-md-10">
                                                            <a href="#" class="text-white"><i class="fa fa-comments-o"></i> <br>
                                                                72 Comments
                                                            </a>
                                                        </li>
                                                        <li class="mt-20 mt-md-10">
                                                            <a href="#" class="text-white"><i class="fa fa-share-square-o"></i> <br>
                                                                Share
                                                            </a>
                                                        </li>
                                                    </ul>
                    ...
                    <div class="col-md-4">
                        <article class="post clearfix">
                            <div class="entry-header">
                                <div class="post-thumb thumb"> <img class="img-responsive img-fullwidth" alt="" src="http://placehold.it/370x350">
                                </div>
                                <div class="entry-meta meta-absolute text-center pl-15 pr-15">
                                    <div class="display-table">
                                        <div class="display-table-cell">
                            ...
                            <div class="entry-content p-20 bg-white">
                                <h4 class="entry-title text-white text-uppercase"><a href="#">Post title here</a></h4>
                                <ul class="entry-date list-inline mt-10 mb-10">
                                    <li><a href="#" class="text-theme-colored">Jan 13, 2015/ Written by: Name</a></li>
                                </ul>
